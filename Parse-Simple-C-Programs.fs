...
module parser =
  ...
  and private exprValue currTok =
    if currTok.Contains "identifier" || currTok.Contains "int_literal" || currTok.Contains "str_literal" || currTok.Contains "true" || currTok.Contains "false" || currTok.Contains "endl" then
      true
    else
      false
